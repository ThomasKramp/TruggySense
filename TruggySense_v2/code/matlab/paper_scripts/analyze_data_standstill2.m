...
%% Show data GPS:
% GPS distance:
datasets = {'Standstill', 'Slow Drive', 'Fast Drive'};
...
for d = 1:3
    ...
    fprintf('Max dist from centroid [%s]: %.2f m | Centroid offset from Standstill: %.2f m\n', ...
...
hold on;
% Scatter plots:
scatter(posLng_standstill, posLat_standstill, 20, 'r', 'filled', 'DisplayName', 'Standstill');
...
grid on;
axis equal;
l = legend('Standstill', 'Slow Drive', 'Fast Drive', ...
