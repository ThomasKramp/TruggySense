...
//circuit board
cb_w = 70;    //circuit board width
cb_d = 50.1+0.6;    //circuit board depth
cb_h = 1.4;     //circuit board height

//circuit board placement
//cb_p_h = 4;   //height
cb_p_s_d = 2;   //sloth depth
cb_b_s = 1;     // back slot yes(1) or no(0)
//circuit board height needs to be changed by the circuit board height

//component opening
cb_p_h_t = 18.5;   //height top
cb_p_h_b = 4;   //height bottom
