 ...
 * @brief Contains class and pins to enable temperature measurements with the internal MCU and DS18B20+ OneWire temperature sensors.
 * @version 1.0
 * @date 2025-04-10
 *
...
/**
 * @brief Class that will initialize, check if the sensor exists and read the value from the sensor
 * 
 */
class Temperature
{
